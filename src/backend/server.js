...
export function getRecommendedPlan(
  ...
  const debtAllocationPercentage =
   ...
   const inflationRatePercentage = 6;
   const postRetirementExpectedReturns = 8;
  ...
  //FV calculation
  const monthlyExpensesAtRetirementAge = currentMonthlyExpenses * Math.pow(1+inflationRatePercentage/100, ageToRetire - age);
  //PV calculation
  recommendedDataMap.set("Retirement Corpus", monthlyExpensesAtRetirementAge*12*100/postRetirementExpectedReturns);
  //recommendedDataMap.set("Monthly Savings", 1100);

  recommendedDataMap.set("Monthly Expenses at Retirement age", monthlyExpensesAtRetirementAge);
  recommendedDataMap.set("Information", "Inflation Rate is considered as 6%. Pre-Retirement ROI is considered as 12%.Post-Retirement ROI is considered as 8%")
